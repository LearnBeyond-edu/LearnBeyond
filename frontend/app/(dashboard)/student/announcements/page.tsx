...
import { Bell, Info, AlertCircle, CheckCircle, Calendar, Search, Megaphone } from "lucide-react";
...
export default function StudentAnnouncementsPage() {
  ...
  const announcements = useMemo(() => {
    const roleMap: Record<string, string> = { "Student": "students" };
  ...
  return (
    <div className="max-w-5xl space-y-6">
      <PageHeader
        title="Announcements"
        subtitle="Important updates and notices from your teachers and school"
      ...
      {announcements.length === 0 ? (
        <EmptyState icon={<Bell className="h-14 w-14" />} title="No announcements found" description="You have no new announcements right now." />
      ) : (
