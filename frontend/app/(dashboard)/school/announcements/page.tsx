...
// Announcements are managed via global store to persist across navigation
// In production these would POST to /notifications with a title + message + target
  ...
  return (
    <div className="space-y-5 max-w-4xl">
      ...
      {announcements.length === 0 ? (
        <EmptyState icon={<Megaphone className="h-14 w-14" />} title="No announcements" description="Create your first announcement to communicate with your school." action={<Button onClick={() => setShowCreate(true)}>Create Announcement</Button>} />
      ) : (
